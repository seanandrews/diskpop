...
magR = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magI = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magJ = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magH = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magK = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magI1 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magI2 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magI3 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magI4 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magM1 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magW1 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magW2 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magW3 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
magW4 = np.full((len(uteff), len(ulogg), len(umh)), np.nan)
