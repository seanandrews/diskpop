...
# master arrays
magU = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magB = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magV = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magR = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magI = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magJ = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magH = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magK = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magI1 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magI2 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magI3 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magI4 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magM1 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magW1 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magW2 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magW3 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
magW4 = np.full((len(uteff), len(ulogg), len(umh)), 1000.)
